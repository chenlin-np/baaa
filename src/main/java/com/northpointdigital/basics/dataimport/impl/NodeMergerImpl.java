...
import com.northpointdigital.basics.dataimport.NodeMerger;

@Component
@Service(value = NodeMerger.class)
@Properties({
	@Property(name = "service.pid", value = "com.northpointdigital.basics.dataimport.nodemerger", propertyPrivate = false),
